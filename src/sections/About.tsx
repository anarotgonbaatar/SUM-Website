...
export default function About() {
	...
	return (
		<section id="about-section">
			...
			<p>Sigma Upsilon Mu (SUM) is a co-ed entrepreneurship fraternity founded in March 2014 at California State University, Fullerton. We’re a community built for people who want to do, not just talk — our motto is “Facta Non Verba” (Deeds, Not Words).</p>
