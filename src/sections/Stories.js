...
function Stories() {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            setCtaText((prevText) =>
                prevText === "Want to be Featured?" ? "Ready to be SUMone?" : "Want to be Featured?"
            )
        }, 1500)
    ...
    return (
        <div className='section' id='stories-section'>
            ...
            <button className='btn' id='stories-cta-btn' onClick={() => scrollToSection( 'footer-section' )}>{ctaText}</button>
